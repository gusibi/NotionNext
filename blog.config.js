...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || 'c0c681cb952d404bb8b80131866eaae9',
      ...
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Gusibi', // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || '后端开发，擅长使用 Python 和 Golang，现在面向AI编程。热爱探索新互联网产品，曾写过小程序。正在学习 Flutter，热衷于技术的探索与进步。', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.gusibi.mobi', // 网站地址
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'gusibi, AI, Go, Python, Notion, 博客', // 网站关键词 英文逗号隔开
      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
      CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
      CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
      CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/gusibi', // 你的github个人主页 例如 https://github.com/tangly1024
      ...
      COMMENT_UTTERRANCES_REPO:
            process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'gusibi/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
